...
import br.com.fiap.kawabanga.databinding.ActivityMainBinding
import br.com.fiap.kawabanga.model.Pedido

class MainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding

    private var tamanhoSelecionado = ""
    private val pizzasSelecionadas = ArrayList<String>()
    ...
    fun calcular(view: View) {
        ...
        alert.setPositiveButton("SIM", DialogInterface.OnClickListener { dialog, which ->
            val intentDetalhePedido = Intent(this, DetalheDoPedidoActivity::class.java)
            val pedido = Pedido(
